...
type WorkShift struct {
	...
	WorkStart  driver.Time `gorm:"type:time(0);not null;comment:上班時間" json:"workStart"`
	WorkEnd    driver.Time `gorm:"type:time(0);not null;comment:下班時間" json:"workEnd"`
	RestStart  driver.Time `gorm:"type:time(0);not null;comment:休息開始時間" json:"restStart"`
	RestEnd    driver.Time `gorm:"type:time(0);not null;comment:休息結束時間" json:"restEnd"`
