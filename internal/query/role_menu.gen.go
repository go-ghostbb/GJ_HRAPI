...
func newRoleMenu(db *gorm.DB, opts ...gen.DOOption) roleMenu {
	...
	_roleMenu.roleMenuDo.UseModel(&types.RoleMenu{})
...
type IRoleMenuDo interface {
	...
	Create(values ...*types.RoleMenu) error
	CreateInBatches(values []*types.RoleMenu, batchSize int) error
	Save(values ...*types.RoleMenu) error
	First() (*types.RoleMenu, error)
	Take() (*types.RoleMenu, error)
	Last() (*types.RoleMenu, error)
	Find() ([]*types.RoleMenu, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*types.RoleMenu, err error)
	FindInBatches(result *[]*types.RoleMenu, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*types.RoleMenu) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*types.RoleMenu, error)
	FirstOrCreate() (*types.RoleMenu, error)
	FindByPage(offset int, limit int) (result []*types.RoleMenu, count int64, err error)
...
func (r roleMenuDo) Create(values ...*types.RoleMenu) error {
	if len(values) == 0 {
		return nil
	}
...
func (r roleMenuDo) CreateInBatches(values []*types.RoleMenu, batchSize int) error {
	return r.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (r roleMenuDo) Save(values ...*types.RoleMenu) error {
	if len(values) == 0 {
		return nil
	}
...
func (r roleMenuDo) First() (*types.RoleMenu, error) {
	if result, err := r.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*types.RoleMenu), nil
	}
}

func (r roleMenuDo) Take() (*types.RoleMenu, error) {
...
func (r roleMenuDo) Last() (*types.RoleMenu, error) {
...
func (r roleMenuDo) Find() ([]*types.RoleMenu, error) {
	result, err := r.DO.Find()
	return result.([]*types.RoleMenu), err
}

func (r roleMenuDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*types.RoleMenu, err error) {
	buf := make([]*types.RoleMenu, 0, batchSize)
...
func (r roleMenuDo) FindInBatches(result *[]*types.RoleMenu, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (r roleMenuDo) FirstOrInit() (*types.RoleMenu, error) {
...
func (r roleMenuDo) FirstOrCreate() (*types.RoleMenu, error) {
...
func (r roleMenuDo) FindByPage(offset int, limit int) (result []*types.RoleMenu, count int64, err error) {
...
func (r roleMenuDo) Delete(models ...*types.RoleMenu) (result gen.ResultInfo, err error) {
