...
func newRolePermission(db *gorm.DB, opts ...gen.DOOption) rolePermission {
	...
	_rolePermission.rolePermissionDo.UseModel(&types.RolePermission{})

	tableName := _rolePermission.rolePermissionDo.TableName()
	_rolePermission.ALL = field.NewAsterisk(tableName)
	_rolePermission.RoleID = field.NewUint(tableName, "role_id")
	_rolePermission.PermissionID = field.NewUint(tableName, "permission_id")
...
func (r *rolePermission) updateTableName(table string) *rolePermission {
	...
	r.PermissionID = field.NewUint(table, "permission_id")
...
type IRolePermissionDo interface {
	...
	Create(values ...*types.RolePermission) error
	CreateInBatches(values []*types.RolePermission, batchSize int) error
	Save(values ...*types.RolePermission) error
	First() (*types.RolePermission, error)
	Take() (*types.RolePermission, error)
	Last() (*types.RolePermission, error)
	Find() ([]*types.RolePermission, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*types.RolePermission, err error)
	FindInBatches(result *[]*types.RolePermission, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*types.RolePermission) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*types.RolePermission, error)
	FirstOrCreate() (*types.RolePermission, error)
	FindByPage(offset int, limit int) (result []*types.RolePermission, count int64, err error)
...
func (r rolePermissionDo) Create(values ...*types.RolePermission) error {
	if len(values) == 0 {
		return nil
	}
...
func (r rolePermissionDo) CreateInBatches(values []*types.RolePermission, batchSize int) error {
	return r.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (r rolePermissionDo) Save(values ...*types.RolePermission) error {
	if len(values) == 0 {
		return nil
	}
...
func (r rolePermissionDo) First() (*types.RolePermission, error) {
	if result, err := r.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*types.RolePermission), nil
	}
}

func (r rolePermissionDo) Take() (*types.RolePermission, error) {
...
func (r rolePermissionDo) Last() (*types.RolePermission, error) {
...
func (r rolePermissionDo) Find() ([]*types.RolePermission, error) {
	result, err := r.DO.Find()
	return result.([]*types.RolePermission), err
}

func (r rolePermissionDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*types.RolePermission, err error) {
	buf := make([]*types.RolePermission, 0, batchSize)
...
func (r rolePermissionDo) FindInBatches(result *[]*types.RolePermission, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (r rolePermissionDo) FirstOrInit() (*types.RolePermission, error) {
...
func (r rolePermissionDo) FirstOrCreate() (*types.RolePermission, error) {
...
func (r rolePermissionDo) FindByPage(offset int, limit int) (result []*types.RolePermission, count int64, err error) {
...
func (r rolePermissionDo) Delete(models ...*types.RolePermission) (result gen.ResultInfo, err error) {
