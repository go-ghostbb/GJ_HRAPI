...
func newCheckInData(db *gorm.DB, opts ...gen.DOOption) checkInData {
	...
	_checkInData.CheckInDateTime = field.NewTime(tableName, "check_in_date_time")
	_checkInData.EmployeeCode = field.NewString(tableName, "employee_code")
...
type checkInData struct {
	...
	CheckInDateTime field.Time
	EmployeeCode    field.String
...
func (c *checkInData) updateTableName(table string) *checkInData {
	...
	c.CheckInDateTime = field.NewTime(table, "check_in_date_time")
	c.EmployeeCode = field.NewString(table, "employee_code")
...
func (c *checkInData) fillFieldMap() {
	...
	c.fieldMap["check_in_date_time"] = c.CheckInDateTime
	c.fieldMap["employee_code"] = c.EmployeeCode
}
